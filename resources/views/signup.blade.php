    ...
    <div class='box-form'>
        ...
        <div class='box-login'>
            <div class='fieldset-body' id='login_form'>
                ...
                @csrf
                <p class='field'>
                    <label for='user'>Фамилия</label>
                    <input type='text' id='user' name='lastname' value="{{ old('lastname') }}" title='Lastname'/>
                    @error('lastname')
                ...
                <p class='field'>
                    ...
                    <input type='text' id='user' name='firstname' value="{{ old('firstname') }}" title='Firstname'/>
                    @error('firstname')
                    <span class='label-text'>{{ $message }}</span>
                    @enderror
                </p>
                <p class='field'>
                    <label for='user'>Отчество</label>
                    <input type='text' id='user' name='patronymic' value="{{ old('patronymic') }}" title='Patronymic'/>
                    @error('patronymic')
                    <span class='label-text'>{{ $message }}</span>
                    @enderror
                </p>
                <p class='field'>
                    ...
                    <input type='text' id='user' name='email' value="{{ old('email') }}" title='Email'/>
                    @error('email')
                    <span class='label-text'>{{ $message }}</span>
                    @enderror
                </p>
                ...
                <input type='submit' id='do_login' value='Зарегистрироваться' title='Get Started' />
            </div>
        </div>
    </div>
</div>
